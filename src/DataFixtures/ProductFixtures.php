...
class ProductFixtures extends Fixture implements DependentFixtureInterface
{
    private const PRODUCTS = [
        ...
        ['[Veranstaltungen] - Grill', 'Speisen', 'Butterbrezel ', 3.50, 'mdi mdi-pretzel'],
        ...
        ['[Veranstaltungen] - Kiosk', 'Speisen', 'Butterbrezel', 3.50, 'mdi mdi-pretzel'],
        ...
        ['[Veranstaltungen] - Neubau', 'Speisen', 'Butterbrezel', 3.50, 'mdi mdi-pretzel'],
        ...
        ['[Veranstaltungen] - Chalet', 'Speisen', 'Butterbrezel', 3.50, 'mdi mdi-pretzel'],
