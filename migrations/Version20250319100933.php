 ...
 */
final class Version20250319100933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sale (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_name VARCHAR(255) NOT NULL, product_name VARCHAR(255) NOT NULL, price_per_item NUMERIC(10, 2) NOT NULL, quantity INTEGER NOT NULL, price NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, transaction_id BLOB NOT NULL)');
